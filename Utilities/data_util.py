...
def get_dataset(env,episode_count=10,time_lim = 1000,model = None,learn_per_iter=10,random=10, reward_fn = (lambda terminated,truncated: -1 if terminated else (1 if truncated else 0) ),pkl_file_path='' ,cast = None):
